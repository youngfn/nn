...
CLASS_INDEX_PATH = ('https://ma-competitions-bj4.obs.cn-north-4.myhuaweicloud.com/'
                    'model_zoo/tensorflow/resnet/imagenet_class_index.json')
...
#                        'model_zoo/resnet/'
#                        'resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5')
WEIGHTS_PATH_NO_TOP = ('https://ma-competitions-bj4.obs.cn-north-4.myhuaweicloud.com:443/'
                       'model_zoo/tensorflow/resnet/'
                       'resnet50_weights_tf_dim_ordering_tf_kernels_notop.h5')
# 说明：原始版本的 imagenet_class_index.json 和 *.h5参数文件都需要连接外网进行下载，由于 ModelArts 训练作业中无法连接外网
# 因此我们手动将 imagenet_class_index.json 和 *.h5参数文件从外网下载下来，再上传到了OBS，之后 ModelArts 训练作业就可以直接访问到OBS中的文件
